...
| `MarkdownRenderer.swift` | ~370 | Renders completed assistant responses as full markdown (headings, lists, code, emphasis). Preprocesses common LaTeX-style math into readable Unicode before parsing. Streaming text stays plain until the turn finishes. |
